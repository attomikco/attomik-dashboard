...
const ALL_PLATFORMS = [
  ...
  { id: 'walmart',  label: 'Walmart',     channelKey: 'walmart', color: '#0071ce', description: 'Seller Center Analytics Overview export', instructions: 'Seller Center → Analytics → Overview → Download CSV', endpoint: '/api/upload/walmart', columns: ['Date', 'GMV', 'Orders', 'Units Sold', 'AUR', 'Refund sales'] },
